...
<form  id="requisition-update-form" method="post" > <div  
     > <div id="div_id_title" class="form-group"> <label for="id_title" class="control-label  requiredField">
                ...
                Date Required<span class="asteriskField">*</span> </label> <div class="controls "> <input type="text" name="date_required" value="2019-06-24" class="dateinput form-control" required id="id_date_required"> </div> </div> <div id="div_id_review_status" class="form-group"> <label for="id_review_status" class="control-label ">
                Status
            </label> <div class="controls "> <select name="review_status" class="select form-control" id="id_review_status"> <option value="">---------</option> <option value="1">Approved</option> <option value="3" selected>Pending</option> <option value="2">Rejected</option>
